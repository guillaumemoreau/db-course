...
--|---|---|---|--
Vegans Ltd  | Watermelon  |  300kg  | 2019/11/15 14:00  | 5 rue des rémouleurs, Poitiers
$\,$  | Potatoes  |  1000kg  |  2019/11/15 14:00 |  5 rue des rémouleurs, Pau
$\,$  | Strawberries  |  100kg  | 2019/11/15 16:30  | 8 rue des marchands, Bayonne
...
Then, select the filename, the saving format (use flat file) and the encoding (use utf-8). Next step consists in selecting the information to include. And the next one in the way to save data. The last is used to select the schemas and tables to include in the backup.
